...
/***/ "./node_modules/@spaceavocado/svelte-router/lib/svelte-router.esm.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@spaceavocado/svelte-router/lib/svelte-router.esm.js ***!
  \***************************************************************************/
...
/* harmony export */   "HASH_TYPE": () => (/* binding */ HASH_TYPE),
/* harmony export */   "ROUTER_MODE": () => (/* binding */ HISTORY_MODE),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "router": () => (/* binding */ router),
/* harmony export */   "trimPrefix": () => (/* binding */ trimPrefix),
/* harmony export */   "urlMatch": () => (/* binding */ urlMatch),
/* harmony export */   "urlPrefix": () => (/* binding */ urlPrefix)
/* harmony export */ });
/* harmony import */ var svelte_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/store */ "./node_modules/svelte/store/index.mjs");
/* harmony import */ var _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @spaceavocado/type-check */ "./node_modules/@spaceavocado/type-check/lib/type-check.esm.js");
...
function fullURL(path, query, hash) {
  ...
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(query)) {
...
function deepClone(o) {
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(o) || _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(o)) {
    return {};
  }
...
function createLocation$1(rawLocation) {
  ...
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.replace) && rawLocation.replace === true) {
    location.action = HISTORY_ACTION.REPLACE;
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.name) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(rawLocation.name)) {
    location.name = rawLocation.name;
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.hash) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(rawLocation.hash)) {
    location.hash = rawLocation.hash.replace('#', '');
  } // Param object


  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.params) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isObject(rawLocation.params)) {
  ...
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.query) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isObject(rawLocation.query)) {
...
function createRouteConfig(prefab) {
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(prefab) || _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(prefab)) {
    throw new Error('invalid route config prefab');
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(prefab.path) || _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isString(prefab.path)) {
    throw new Error('invalid route config path property');
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(prefab.component) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isFunction(prefab.component) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isPromise(prefab.component)) {
    throw new Error('invalid route config component property');
  }

  if (prefab.meta && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(prefab.meta)) {
    throw new Error('invalid route config meta property');
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(prefab.redirect)) {
    prefab.redirect = null;
  } else if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isString(prefab.redirect) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(prefab.redirect) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isFunction(prefab.redirect)) {
    throw new Error('invalid route config redirect property');
  }

  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(prefab.props)) {
    prefab.props = false;
  } else if (prefab.props !== true && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(prefab.props) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isFunction(prefab.props)) {
  ...
  return {
    ...
    async: _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(prefab.component) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isPromise(prefab.component),
    name: prefab.name,
    meta: prefab.meta || {},
    props: prefab.props,
    children: [],
...
function createRouteRecord(route, params) {
  ...
  var resolveNumber = function resolveNumber(s) {
    if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNumber(s)) {
      return s;
    }
  ...
  if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isObject(params)) {
    setParamValue = function setParamValue(key, collection) {
      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(params[key])) {
...
function () {
  ...
  function Router(opts) {
    ...
    if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isEnumKey(opts.mode, HISTORY_MODE)) {
      throw new Error("invalid router mode, \"".concat(opts.mode, "\""));
    }

    opts.historyOpts.basename = opts.basename || '';

    if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isString(opts.historyOpts.basename)) {
    ...
    if (opts.mode == HISTORY_MODE.HASH) {
      ...
      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isEnumKey(opts.historyOpts.hashType, HASH_TYPE)) {
  ...
  _createClass(Router, [{
    ...
    value: function push(rawLocation, onComplete, onAbort) {
      ...
      try {
        ...
        if (onAbort && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isFunction(onAbort)) {
          onAbort();
        }
      ...
      this.resolveRoute(location, _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isFunction(onComplete) ? onComplete : undefined, _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isFunction(onAbort) ? onAbort : undefined);
    }
    /**
    ...
    value: function routeURL(rawLocation) {
      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(rawLocation)) {
        throw new Error('invalid rawLocation');
      }

      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isNullOrUndefined(rawLocation.name) || _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isString(rawLocation.name)) {
        throw new Error('missing or invalid route name');
      }

      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.params) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(rawLocation.params)) {
        throw new Error('invalid params property, expected object.');
      }

      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.query) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isObject(rawLocation.query)) {
        throw new Error('invalid query property, expected object.');
      }

      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined(rawLocation.hash) && _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isString(rawLocation.hash)) {
    ...
    value: function rawLocationToLocation(rawLocation, replace) {
      ...
      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(rawLocation)) {
        rawLocation = {
          path: rawLocation
        };
      }
    ...
    value: function resolveRedirect(redirect, onComplete, onAbort) {
      // Function
      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isFunction(redirect)) {
        redirect = redirect(this._pendingRoute);
      } // External


      if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(redirect) && hasPrefix(redirect, 'http')) {
      ...
      this._pendingRoute = null;
      this.push(_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(redirect) ? redirect : redirect, onComplete, onAbort);
    }
    /**
    ...
    value: function resolveNavigationGuard() {
      ...
      this._navigationGuards[index].guard(this._currentRoute, this._pendingRoute, function (next) {
        ...
        if (next == undefined) {
          _this5.resolveNavigationGuard(++index, onComplete, onAbort); // Cancel the route change

        } else if (next === false) {
          abort(); // Error
        } else if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isError(next)) {
          abort(next); // Go to different route
        } else if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isString(next) || _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isObject(next)) {
          _this5._pendingRoute = null;
...
var createRouter = function createRouter(opts) {
  router = (0,svelte_store__WEBPACK_IMPORTED_MODULE_0__.readable)(new Router(opts));
  return router;
};
...
/***/ "./node_modules/@spaceavocado/type-check/lib/type-check.esm.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@spaceavocado/type-check/lib/type-check.esm.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TypeCheckError": () => (/* binding */ TypeCheckError),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
...
/***/ "./node_modules/@spaceavocado/svelte-router/component/view.svelte":
/*!************************************************************************!*\
  !*** ./node_modules/@spaceavocado/svelte-router/component/view.svelte ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @spaceavocado/type-check */ "./node_modules/@spaceavocado/type-check/lib/type-check.esm.js");
/* harmony import */ var _spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @spaceavocado/svelte-router */ "./node_modules/@spaceavocado/svelte-router/lib/svelte-router.esm.js");
...
/* node_modules\@spaceavocado\svelte-router\component\view.svelte generated by Svelte v3.50.1 */
...
function create_if_block_1(ctx) {
  ...
  return {
    ...
    p: function p(ctx, dirty) {
      ...
      /*$router, viewProps*/
      12 ? (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.get_spread_update)(switch_instance_spread_levels, [dirty &
      /*$router*/
      8 && {
        route:
        /*$router*/
...
function create_if_block(ctx) {
  ...
  return {
    c: function c() {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_component)(view_1.$$.fragment);
    },
    m: function m(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(view_1, target, anchor);
      current = true;
    },
    p: svelte_internal__WEBPACK_IMPORTED_MODULE_0__.noop,
    i: function i(local) {
      if (current) return;
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_in)(view_1.$$.fragment, local);
      current = true;
    },
    o: function o(local) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_out)(view_1.$$.fragment, local);
      current = false;
    },
    d: function d(detaching) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(view_1, detaching);
    }
  };
}
...
var CONTEXT_KEY = 'VIEW_DEPTH';

function instance($$self, $$props, $$invalidate) {
  var $router;
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.component_subscribe)($$self, _spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_2__.router, function ($$value) {
    return $$invalidate(3, $router = $$value);
  });
  var self = false;
  var view = null;
  var viewPropsMethod = null;
  var viewProps = {};
  var viewDepth = 0;
  var navigationChangedListener = null; // Get closest parent view depth

  var parentViewDepth = (0,svelte__WEBPACK_IMPORTED_MODULE_3__.getContext)(CONTEXT_KEY);
  viewDepth = parentViewDepth || 0;
  (0,svelte__WEBPACK_IMPORTED_MODULE_3__.setContext)(CONTEXT_KEY, viewDepth + 1);
  /**
  ...
  */
  ...
  function setViewProps(currentRoute) {
    ...
    } else if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isFunction(viewPropsMethod)) {
      $$invalidate(2, viewProps = viewPropsMethod(currentRoute)); // Function
    } else if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].isObject(viewPropsMethod)) {
  ...
  (0,svelte__WEBPACK_IMPORTED_MODULE_3__.onMount)(function () {
    ...
    navigationChangedListener = $router.onNavigationChanged(function (from, to) {
    ...
    if (_spaceavocado_type_check__WEBPACK_IMPORTED_MODULE_1__["default"].not.isNullOrUndefined($router.currentRoute) && viewDepth < $router.currentRoute.matched.length) {
...
var View = /*#__PURE__*/function (_SvelteComponent) {
...
/* harmony export */ });
/* harmony import */ var svelte_internal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/internal */ "./node_modules/svelte/internal/index.mjs");
/* harmony import */ var _spaceavocado_svelte_router_component_view_svelte__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @spaceavocado/svelte-router/component/view.svelte */ "./node_modules/@spaceavocado/svelte-router/component/view.svelte");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
/* resources\js\App.svelte generated by Svelte v3.50.1 */
...
function create_fragment(ctx) {
  var routerview;
  var current;
  routerview = new _spaceavocado_svelte_router_component_view_svelte__WEBPACK_IMPORTED_MODULE_1__["default"]({});
  return {
    c: function c() {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_component)(routerview.$$.fragment);
    },
    m: function m(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(routerview, target, anchor);
      current = true;
    },
    p: svelte_internal__WEBPACK_IMPORTED_MODULE_0__.noop,
    i: function i(local) {
    ...
    d: function d(detaching) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(routerview, detaching);
    }
  };
}
...
/***/ "./resources/js/component/NotFound.svelte":
/*!************************************************!*\
  !*** ./resources/js/component/NotFound.svelte ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* resources\js\component\NotFound.svelte generated by Svelte v3.50.1 */
...
var NotFound = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(NotFound, _SvelteComponent);
...
/***/ "./resources/js/student/create.svelte":
/*!********************************************!*\
  !*** ./resources/js/student/create.svelte ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* resources\js\student\create.svelte generated by Svelte v3.50.1 */
...
/***/ "./resources/js/student/index.svelte":
/*!*******************************************!*\
  !*** ./resources/js/student/index.svelte ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var svelte_internal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/internal */ "./node_modules/svelte/internal/index.mjs");
/* harmony import */ var _spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @spaceavocado/svelte-router */ "./node_modules/@spaceavocado/svelte-router/lib/svelte-router.esm.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
/* resources\js\student\index.svelte generated by Svelte v3.50.1 */
...
function instance($$self, $$props, $$invalidate) {
  var $router;
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.component_subscribe)($$self, _spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_1__.router, function ($$value) {
    return $$invalidate(1, $router = $$value);
  });
...
var Student = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(Student, _SvelteComponent);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @spaceavocado/svelte-router */ "./node_modules/@spaceavocado/svelte-router/lib/svelte-router.esm.js");
/* harmony import */ var _component_NotFound_svelte__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../component/NotFound.svelte */ "./resources/js/component/NotFound.svelte");
/* harmony import */ var _student_index_svelte__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../student/index.svelte */ "./resources/js/student/index.svelte");
/* harmony import */ var _student_create_svelte__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../student/create.svelte */ "./resources/js/student/create.svelte");
...
var routes = [{
  path: '/',
  component: _student_index_svelte__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  path: '/create',
  component: _student_create_svelte__WEBPACK_IMPORTED_MODULE_3__["default"]
}, {
  path: '*',
  component: _component_NotFound_svelte__WEBPACK_IMPORTED_MODULE_1__["default"]
}];
var router = (0,_spaceavocado_svelte_router__WEBPACK_IMPORTED_MODULE_0__["default"])({
  routes: routes
});
